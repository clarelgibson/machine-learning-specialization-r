...
```
    ...
    ## [5,]  0.24 3.94 3.96 2.48
    ## [6,]  0.24 3.95 3.98 2.47
...
| x             |         0 |             1 | 5.73 | 1.12 | 0.0 | 4.71 | 5.69 | 6.54 | 10.74 | ▁▁▇▃▁ |
| y             |         0 |             1 | 5.73 | 1.11 | 0.0 | 4.72 | 5.71 | 6.54 | 10.54 | ▁▁▇▅▁ |
| z             |         0 |             1 | 3.54 | 0.71 | 0.0 | 2.91 | 3.52 | 4.03 | 31.80 | ▇▁▁▁▁ |
...
| skim_variable | n_missing | complete_rate | mean | sd | p0 | p25 | p50 | p75 | p100 | hist |
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|:---|
| price | 0 | 1 | 3930.97 | 3989.72 | 326 | 949 | 2399 | 5320.25 | 18818 | ▇▂▁▁▁ |
...
```
    ...
    ## [1] "Cost at initial w,b: 15684156.4687763"
...
```
    ...
    ## Time difference of 14.4851 secs
